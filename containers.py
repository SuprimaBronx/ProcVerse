...
def multimethods(cars, out_name):
    ...
    try:
        for i in range(0, len(cars), 2):
            ...
            out_name.write('расход топлива: ' + str(cars[i].fuel_consumption) + "\n")
            out_name.write('Отношение веса груза к мощности двигателя: ' + str(cars[i].ratio) + "\n")
            out_cars(cars[i + 1], out_name, i + 1)
            out_name.write('мощность двигателя: ' + str(cars[i + 1].engine_power) + "\n")
            out_name.write('расход топлива: ' + str(cars[i + 1].fuel_consumption) + "\n")
            out_name.write('Отношение веса груза к мощности двигателя: ' + str(cars[i + 1].ratio) + "\n")
    except:
        ...
        out_name.write('расход топлива: ' + str(cars[-1].fuel_consumption) + "\n")
        out_name.write('Отношение веса груза к мощности двигателя: ' + str(cars[-1].ratio) + "\n")
